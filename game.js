class Game {
  ...
  play() {
    ...
    if (allPlayers !== undefined) {
      ...
      //420 416
      tile_1 = createSprite(450, 180, 10, 10)
     // tile_1.shapeColor = "white"
      ...
      if (allPlayers.player1.tool == "o") {
        tool_image = loadImage("spider.png")
      } else {
        tool_image = loadImage("skeleton.png")
      }
     
      if (mousePressedOver(tile_1)) {
       
       img=createSprite(450,180,100,100)  
        
      
       img.addImage(tool_image)
